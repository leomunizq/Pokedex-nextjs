  ...
  return (
    <>
      <div
        ...
        class="z-50 fixed top-0 left-0 right-0 bottom-0 flex items-center w-full h-full p-4 bg-gray-800 bg-opacity-50 overflow-y-auto"
      >
        <div class="max-w-xl w-full mx-auto bg-gray-500 rounded-xl overflow-hidden">
          <div class="max-w-sm mx-auto pt-12 pb-8 px-5 text-center">
            ...
            <p class="text-gray-300 font-medium">
              Your account is important to you. Before deactivating it, please
              ensure that you have backed up all of your data.
            </p>
          </div>
